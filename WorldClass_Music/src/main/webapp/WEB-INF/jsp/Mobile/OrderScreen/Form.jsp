...
<div class="modal-body" >
	...
	<div class="col-md-10 col-sm-10 col-xs-10 col-lg-10">
		<div style="border: 1px solid #EAEAEA; width: 100%; height: 150px; overflow:auto">
			<label>주문 메뉴 구성</label>
	            ...
	            <div style="margin-top:4px; overflow-y: auto; height: 150px; width: 100%;" id="menuTree">
	            </div>
		...
		<div style="border: 1px solid #EAEAEA; width: 100%; height: 250px; overflow:auto">
			<label>주문 메뉴 구성</label>
	...
	<div class="col-md-10 col-sm-10 col-xs-10 col-lg-10">
		<div>
			...
			<div id="targetTreeList" style="border: 1px solid #EAEAEA; height: 150px; overflow-y:scroll;" class="proton-demo"></div>
		</div>
	</div>
...
<div class="modal-footer">
	<button type="button" class="btn btn-primary pull-left" onclick="addBtn()" id="addbtn">주문 메뉴 별 상품 추가</button>
	<button type="button" class="btn btn-primary pull-left" onclick="orderScreenSave()" id="procBtn">저장</button>
	<button type="button" class="btn btn-default notDisabled pull-left" data-dismiss="modal">닫기</button>
</div>
...
<script type="text/javaScript">
	...
	$(document).ready(function () {
		$('.modal-dialog').css('width', '500px').css('height', '500px');
	...
	function orderScreenSave()
	{
		...
		for(var i = 0; i < menuTreeArr.length; i++)
		{
			...
			$("#sortable"+id).find("li.ui-sortable-handle").each(function(index) {
				var prodItem = {};
				prodItem.domainIdx = $("#orderScreenForm #domainIdx").val();
				prodItem.brandIdx = $("#orderScreenForm #brandIdx").val();
				prodItem.francIdx = $("#orderScreenForm #francIdx").val();
	...
	function addBtn(id){
		...
		if(snodes == null || snodes[0] == "menu0"){
			...
			$.sessionCheck();
	    	$.modalCommon.loadView('상품 추가', '<c:url value="/Mobile/OrderScreen/ProductForm"/>'	);
		}
