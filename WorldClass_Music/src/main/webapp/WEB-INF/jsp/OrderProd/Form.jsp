	...
	<div class="modal-body" style="height:750px;">
		<div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
			...
			<div class="form-inline" >
				...
				<div id="DataTable" style="margin-bottom: 10px;"></div>
			</div>
		...
		<div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
			<div class="form-inline">
				...
				<img id="prodImageUrl" name="prodImageUrl" src="/Content/images/empty2.jpg" style="cursor: pointer;width: 430px;height: 430px;" onclick="FilePopAdd();"/>
			</div>
		</div>
...
<script type="text/javaScript">
	$(document).ready(function () {
		...
		$('.modal-dialog').css('width', '1300px').css('height', '1200px');;
...
// 			console.log(screenRowData);
	...
	function addBtn(id){
	    $.modalCommon.loadFullDataView('<i class="fa fa-fw fa-gear"></i> 옵션 상품 추가', '<c:url value="/OrderProd/OptionProdForm"/>' , {brandIdx: $('#user #brandIdx').val() , francIdx: $('#user #francIdx').val()});
	};
